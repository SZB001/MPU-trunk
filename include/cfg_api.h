...
#define CFG_PARA_DBC_PATH   "/usrdata/dbc/GB-EP30_CAN_r5_001_v1.7.dbc"
...
typedef enum CFG_PARA_ITEM_ID
{
    ...
    CFG_ITEM_EN_PKI,
    CFG_ITEM_EN_HUPKI,
    CFG_ITEM_EN_OTAMODEIN,
    CFG_ITEM_EN_CANFILE,
    CFG_ITEM_MPUREBOOT_DATE,
    CFG_ITEM_MPUREBOOT_TIMES,
	CFG_ITEM_EN_STARTFLAG,
    CFG_ITEM_SLEEP_TS,
    CFG_ITEM_ID_MAX,
} CFG_PARA_ITEM_ID;
