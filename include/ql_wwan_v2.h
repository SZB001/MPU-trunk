...
typedef struct
{
    ...
    ql_data_call_error_e
    err;                       /*!< The Reason code after data call disconnected. */
    union
    {
...
typedef struct
{
    ...
    ql_apn_pdp_type_e
    pdp_type;             /*!< Packet Data Protocol (PDP) type specifies the type of data payload
 ...
 *
 */
extern int QL_Data_Call_Stop(char profile_idx, ql_data_call_ip_family_e ip_family,
