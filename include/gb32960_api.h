...
extern long gb_data_cellOverTemp(void);
extern long gb_data_underVoltSts(void);
extern long gb_data_IsolSuperSts(void);
extern long gb_data_tempDiffSts(void);
extern long gb_data_tyrePressWarnSts(unsigned char obj);
extern long gb_data_tyreLeakWarnSts(unsigned char obj);
extern long gb_data_tyreHighTempWarnSts(unsigned char obj);
extern long gb_data_BDMSysFail(void);
