...
CFG_ITEM_BEGIN()
CFG_ITEM_ID(CFG_ITEM_EN_OTAMODEIN)
CFG_MEMBER_BEGIN()
CFG_MEMBER("OTAMODEIN EN", CFG_DATA_UCHAR, 1)
CFG_MEMBER_END()
CFG_ITEM_END()

CFG_ITEM_BEGIN()
CFG_ITEM_ID(CFG_ITEM_EN_CANFILE)
CFG_MEMBER_BEGIN()
CFG_MEMBER("CANFILE EN", CFG_DATA_UCHAR, 1)
CFG_MEMBER_END()
CFG_ITEM_END()

CFG_ITEM_BEGIN()
CFG_ITEM_ID(CFG_ITEM_MPUREBOOT_DATE)
CFG_MEMBER_BEGIN()
CFG_MEMBER("mpu reboot datetime", CFG_DATA_UINT, 4)
CFG_MEMBER_END()
CFG_ITEM_END()

CFG_ITEM_BEGIN()
CFG_ITEM_ID(CFG_ITEM_MPUREBOOT_TIMES)
CFG_MEMBER_BEGIN()
CFG_MEMBER("mpu reboot times", CFG_DATA_UCHAR, 1)
CFG_MEMBER_END()
CFG_ITEM_END()

CFG_ITEM_BEGIN()
CFG_ITEM_ID(CFG_ITEM_EN_STARTFLAG)
CFG_MEMBER_BEGIN()
CFG_MEMBER("STARTFLAG", CFG_DATA_UCHAR, 1)
CFG_MEMBER_END()
CFG_ITEM_END()

CFG_ITEM_BEGIN()
CFG_ITEM_ID(CFG_ITEM_SLEEP_TS)
CFG_MEMBER_BEGIN()
CFG_MEMBER("timestamp when going to sleep", CFG_DATA_UINT, 4)
CFG_MEMBER_END()
CFG_ITEM_END()
