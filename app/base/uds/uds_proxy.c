...
/*����tbox uds server ģʽ��������� or Զ����ϣ�ֻ����Ĭ�ϻỰ����δ������ȫ�ȼ�ʱ�ɸ���ģʽ*/
...
int is_remote_diag_response(unsigned char * msg)
{
    ...
    switch (msg_type)
    {
        case MSG_ID_UDS_S_ACK:/*����UDS server*/
            ret = 0;
            break;
            
        case MSG_ID_UDS_C_ACK:/*����UDS client*/
            ret = 1;
            break;
...
int uds_proxy_init(void)
{
  //  int ret = 0;
    ...
    uds_client.timer_t[P2CLINT].timer_value = 1000;
...
void uds_timeout(UDS_TIMER_E timer_id, uint16_t seq)
{
    ...
    switch (timer_id)
    {
        ...
        case S3SERVER:
            ...
            UDS_SetDTCOn();
            uds_send_can_CommunicationControl_to_mcu(2, 0);/*��ʼ��ͨ�ſ��ơ����б��ģ������շ�*/
