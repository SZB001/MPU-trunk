...
#define NM_MAX_DIAL_LINK_DIAG_INTERVAL     (30*60*1000)   /* unit is ms, 30min */
#else
...
typedef struct
{
    ...
    unsigned long long  start_time;      /* if network is normal, it is not used, otherwise it is the starttime of the fault omit */
