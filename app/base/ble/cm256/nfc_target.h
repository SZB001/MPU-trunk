...
#if ((NFC_BRCM_NOT_OPEN_INCLUDED == TRUE) && (NFC_RW_ONLY == FALSE))

#ifndef NFC_CE_T1T_T2T_INCLUDED
#define NFC_CE_T1T_T2T_INCLUDED  TRUE
#endif
...
#else /* NFC_BRCM_NOT_OPEN_INCLUDED == FALSE || NFC_RW_ONLY == TRUE */
#define NFC_CE_T1T_T2T_INCLUDED  FALSE
#endif /* NFC_BRCM_NOT_OPEN_INCLUDED == FALSE || NFC_RW_ONLY == TRUE */
