...
int fota_uds_get_version_gw(uint8_t *s_ver, int *s_siz, uint8_t *h_ver, int *h_siz, uint8_t *sn, int *sn_siz)
{
...
int fota_uds_get_version(uint8_t *s_ver, int *s_siz, uint8_t *h_ver, int *h_siz, uint8_t *sn, int *sn_siz)
{
    fota_uds_read_data_by_identifier((uint8_t *)"\xF1\x87", sn, sn_siz);
    fota_uds_read_data_by_identifier((uint8_t *)"\xF1\x88", s_ver, s_siz);
    fota_uds_read_data_by_identifier((uint8_t *)"\xF1\x91", h_ver, h_siz);
